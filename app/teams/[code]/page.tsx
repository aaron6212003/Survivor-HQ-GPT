...
interface TeamResearch { weather?: { kind:string; temperature?:number; unit?:string; wind?:string; forecast?:string } | null; injuries?: { available:boolean; total?:number; players?: {player:string; position?:string; status?:string}[] }; }
