  ...
  return (
    <html lang="en" className="dark">
      <body className="bg-[#080b10] text-slate-100 min-h-screen flex flex-col font-sans antialiased">
        <AccountProvider>
        <Navbar />
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-5 sm:py-6 md:pb-12">
          {children}
        </main>
        <footer className="site-footer bg-[#0b1017] border-t border-slate-800 py-6 text-center text-xs text-slate-500">
