...
export function activeWeek(league,meta) {return Math.max(league.resumeWeek||1,league.startWeek,league.season<meta.season?18:league.season>meta.season?league.startWeek:meta.week);}
